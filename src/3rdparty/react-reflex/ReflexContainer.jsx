...
import {getRotatedXY} from '../../js/lib/rotatehelper';
...
class ReflexContainer extends React.Component {
  ...
  getOffset (event) {
    ...
    const rotatedPos = getRotatedXY(pos, 'page', this.props.rotateMode);

    switch (this.props.orientation) {

      case 'horizontal':
        return rotatedPos.y - this.previousPos

      case 'vertical':
        return rotatedPos.x - this.previousPos
    }
  }
  ...
  onSplitterStartResize (data) {
    ...
    switch (this.props.orientation) {
      ...
      case 'horizontal':
        ...
        this.previousPos = rotatedPos.y
        break

      case 'vertical':
        document.body.style.cursor = 'col-resize'
        this.previousPos = rotatedPos.x
        break
    }
